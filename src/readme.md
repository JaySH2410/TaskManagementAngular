# 🖥️ Task Management Frontend – Angular 17 (Standalone + Signals)

This is the frontend UI for the **Task Management System**, built using **Angular 17** with **Standalone Components**, **Signals state management**, **HttpClient API integration**, and **Tailwind CSS** for styling. The application interacts with the ASP.NET Core Web API backend to perform task and category management operations.
